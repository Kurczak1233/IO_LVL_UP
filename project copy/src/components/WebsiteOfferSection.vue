...
<b-container fluid class="begginer-banner">
  <b-row class="pt-5 pb-5">
    ...
    <b-col class="Second-part my-auto" cols="12" md="3"><b-img class="img-fluid" src="https://github.com/Kurczak1233/IO_LVL_UP/blob/Karolina/project%20copy/src/assets/3161e1ebbecb7efcb9bbb2b011ff489d.png?raw=true" alt="English book"></b-img></b-col>
<b-col class="text-center d-block d-md-none mt-2 mb-5" md=12>Unique materials!</b-col>
 <b-col class="img fluid-md d-none d-md-block my-auto" cols="12" md="6"><b-img class="First-part img-fluid" src="https://github.com/Kurczak1233/IO_LVL_UP/blob/Asia/project%20copy/src/assets/Small%20CERF%20lvls.png?raw=tru" alt="CERF Levels from B12222+"></b-img></b-col>
    <b-col class="img fluid-md d-xsm-block d-md-none mt-3 my-auto" cols="12" md="6"><b-img class="First-part img-fluid" src="https://github.com/Kurczak1233/IO_LVL_UP/blob/Asia/project%20copy/src/assets/Small%20CERF%20lvls.png?raw=tru" alt="CERF Levels from B1+"></b-img></b-col>
