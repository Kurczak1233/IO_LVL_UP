...
<b-container fluid class="begginer-banner">
  <b-row class="pt-5 pb-5">
    <b-col class="Second-part my-auto" cols="12" md="3"><b-img class="img-fluid" src="https://pin.it/2pZyGyJ" alt="ksiazka vector icon"></b-img></b-col>
...
<b-col class="text-center d-block d-md-none mt-2 mb-5" md=12>Clear education career!</b-col>  
    <b-col class="Third-part my-auto" cols="12" md="3"><b-img class="img-fluid" src="https://www.freepik.com/free-icon/calendar-circle-interface-symbol_725561.htm" alt="kalendarz vector icon"></b-img></b-col>
