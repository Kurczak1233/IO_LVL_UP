...
<b-container fluid class="begginer-banner">
  <b-row class="pt-5 pb-5">
    <b-col class="Second-part my-auto" cols="12" md="3"><b-img class="img-fluid" src="https://github.com/Kurczak1233/IO_LVL_UP/blob/Karolina/project%20copy/src/assets/3161e1ebbecb7efcb9bbb2b011ff489d.png?raw=true" alt="ksiazka vector icon"></b-img></b-col>
...
<b-col class="text-center d-block d-md-none mt-2 mb-5" md=12>Clear education career!</b-col>  
    <b-col class="Third-part my-auto" cols="12" md="3"><b-img class="img-fluid" src="https://github.com/Kurczak1233/IO_LVL_UP/blob/Karolina/project%20copy/src/assets/kissclipart-add-to-calendar-icon-png-clipart-computer-icons-ca-2a4fbdab8daf6d7d.png?raw=true" alt="kalendarz vector icon"></b-img></b-col>
