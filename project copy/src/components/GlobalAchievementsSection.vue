...
<b-container class="background-color pb-5" fluid>
    ...
    <b-col cols="12" class="pb-1">
        <img id="banner" class="img-fluid text-center pt-5 pb-5" src="tps://github.com/Kurczak1233/IO_LVL_UP/blob/Kurczak1233/project%20copy/src/assets/pngfind.com-world-png-592818%20(1).png?raw=true" alt="Logo projektu"> 
    </b-col>
