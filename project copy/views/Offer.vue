  ...
  <body>
    <b-container class="col-11 col-md-11 col-xl-10 mr-auto ml-auto margin5 background-bluish" fluid>
        ...
        <b-row class="mt-4 pb-4 ml-4">
            <b-col class="col-5 d-none d-xl-block"><img src="https://github.com/Kurczak1233/IO_LVL_UP/blob/main/project%20copy/src/assets/Skala%20poprawiona%20beg.png?raw=true" class="img-fluid img-fluid-class" alt="Cerf levels"></b-col>
