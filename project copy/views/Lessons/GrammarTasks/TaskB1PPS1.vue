  ...
  <tbody>
    ...
    <tr>
      ...
      <td v-on:click="inputClickedRight">Prior</td>
        ...
        <b-row>  
            <b-col class="mt-3 mb-3 text-center"><router-link :to="{name: 'gram', params: {solvedB1PPS1: true}}" ><b-button class="btn btn-warning" type="button" v-on:click="AddSolvedToUserDb">Solved!</b-button></router-link></b-col>
        </b-row>
</b-container>
  </body>
</template>
...
export default {
  ...
  {
      this.solvedB1PPS1 = true;
      var db = firebase.firestore();
      db.collection(this.email).doc(this.email).set({solvedB1PPS1: this.solvedB1PPS1} ,{merge:true})
  }
    }
}
</script>
