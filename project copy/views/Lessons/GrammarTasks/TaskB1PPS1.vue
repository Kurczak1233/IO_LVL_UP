<template>
  <body>
    <b-container v-if="ConifmedInfo===false" class="col-10 mt-5 col-md-8 col-xl-8 mr-auto ml-auto background-bluish" fluid>
        <b-row>
            <b-col class="text-primary"><p>You are in tasks section, please remember that you are constantly LEARNING so, do not forget to make notes, and if necessary - repeat quizes!</p>
                <p></p>
            </b-col>
        </b-row>
    </b-container>
